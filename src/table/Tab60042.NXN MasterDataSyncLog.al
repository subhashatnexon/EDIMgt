table 60042 "NXN Master Data Sync Log"
{
    ...
    fields
    {
        ...
        field(23; Synced; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(24; "Synced Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(25; "Synced Time"; Time)
        {
            DataClassification = ToBeClassified;
        }
        field(26; "Error Occured"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(27; "Error Message"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        field(28; "From Company Name"; Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(29; "To Company Name"; Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(30; "Part of Primary Key"; Boolean)
        {
    ...
    var
        ...
        MasterLogManagement: Codeunit "NXN Master Data Log Mgt";
        RecordRef: RecordRef;
        FieldRef: FieldRef;
    ...
    begin
        ...
        IF NOT AllObj.ISEMPTY AND (Value <> '') AND HasCultureNeutralValues THEN BEGIN
            ...
            IF RecordRef.FIELDEXIST("Field No.") THEN BEGIN
                ...
                IF MasterLogManagement.EvaluateTextToFieldRef(Value, FieldRef) THEN
